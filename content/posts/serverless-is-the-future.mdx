...
First of all, the 'serverless' word is not literally without server. Your application will had the frontend folder,
...
## Future
With the insane growth of AI models, i believe in a future where more applications will be made with serverless architecture, with a lot of 
